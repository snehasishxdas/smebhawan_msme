...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://byzrociqsrniqjquhstu.supabase.co'
const SUPABASE_ANON_KEY = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_pMDFtguWUx6nsBzoRwdQWw_lgjjGqX8'

// Mock mode is disabled since we are connected to the live Supabase project
const IS_MOCK_SUPABASE = false
